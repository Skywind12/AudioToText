...
description: Transcribe user-attached audio files (WAV, MP3, M4A, OGG, FLAC) to text using Whisper. Use whenever the user attaches an audio file and asks what it says, wants a transcript, wants it summarized, or asks any question about the audio's spoken content.
---
